        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div 
              ...
              data-aos-once="true"
            >
              <div className="single-services-box border" style={{ backgroundImage: `url(/images/services/services1.jpg)` }}>
                <div className="d-flex align-items-center">
                  <img src="/images/icon/icon8.png" alt="image" />
                  <h3>
                    <a href="/service-details">Branding</a>
                  </h3>
                </div>
                <p>
            ...
            <div 
              ...
              data-aos-once="true"
            >
              <div className="single-services-box border" style={{ backgroundImage: `url(/images/services/services2.jpg)` }}>
                <div className="d-flex align-items-center">
            ...
            <div 
              ...
              data-aos-once="true"
            >
              <div className="single-services-box border" style={{ backgroundImage: `url(/images/services/services3.jpg)` }}>
                <div className="d-flex align-items-center">
                  <img src="/images/icon/icon10.png" alt="image" />
                  <h3>
                    <a href="/service-details">Content</a>
                  </h3>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
            ...
            <div 
              ...
              data-aos-once="true"
            >
              <div className="single-services-box border" style={{ backgroundImage: `url(/images/services/services4.jpg)` }}>
                <div className="d-flex align-items-center">
            ...
            <div 
              ...
              data-aos-once="true"
            >
              <div className="single-services-box border" style={{ backgroundImage: `url(/images/services/services5.jpg)` }}>
                <div className="d-flex align-items-center">
                  <img src="/images/icon/icon12.png" alt="image" />
                  <h3>
                    <a href="/service-details">Marketing</a>
                  </h3>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
            ...
            <div 
              ...
              data-aos-once="true"
            >
              <div className="single-services-box border" style={{ backgroundImage: `url(/images/services/services6.jpg)` }}>
                <div className="d-flex align-items-center">
                  <img src="/images/icon/icon13.png" alt="image" />
                  <h3>
                    <a href="/service-details">Technology</a>
                  </h3>
                </div>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
